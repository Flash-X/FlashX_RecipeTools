...
!! This version has changes for trying async PM communications - KW
...
subroutine TimeAdvance(dt, dtold, time)
   ...
   use Grid_ddComm,   ONLY : Grid_ddComm_t
   ...
   call Grid_buildDdComm(comm)
   call comm % setGcFillOptions(CENTER,ALLDIR,doEos=.true.,&
       selectBlockType=LEAF)
!!$  comm % fullySeparateGcFill = .TRUE. ! Enable this line to force synchronous comm - KW
