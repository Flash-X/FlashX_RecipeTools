# Flash-X Makefile header for ylee's desktop (NVHPC)
#----------------------------------------------------------------------------
...
OPENMP = -mp
OMP_CUDA = -Minfo=mp,accel -gpu=cc86
